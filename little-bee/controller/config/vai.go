...
func CreateVai(c *gin.Context) {
	...
	if err := serialization.UnmarshalFromJson(string(buf), l); err != nil {
		...
		r, err := vai.CreateVai(l, userId.(int32))
		if err != nil {
...
func RetrieveVai(c *gin.Context) {
	lang := c.Request.FormValue("lang")
	acceptLanguage := c.Request.Header.Get("Accept-Language")
	c.Writer.Header().Set("Content-Type", "application/json")

	if vaiId, err := strconv.Atoi(c.Param("vai-id")); err != nil {
		...
		r, err := vai.RetrieveVai(int32(vaiId))
		if err != nil {
...
func UpdateVai(c *gin.Context) {
	...
	if err := serialization.UnmarshalFromJson(string(buf), l); err != nil {
		...
		userId, _ := c.Get("userId")
		err := vai.UpdateVai(l, userId.(int32))
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_WRITE_DATABASE, nil, lang, acceptLanguage, err))
		} else {
...
func DeleteVai(c *gin.Context) {
	...
	if vaiId, err := strconv.Atoi(c.Param("vai-id")); err != nil {
		...
		userId, _ := c.Get("userId")
		err := vai.DeleteVai(vaiId, userId.(int32))
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_WRITE_DATABASE, nil, lang, acceptLanguage, err))
		} else {
			c.String(http.StatusOK, "%s", response.ResponseSuccessJson(nil))
...
func DeleteVaiWithFlag(c *gin.Context) {
	lang := c.Request.FormValue("lang")
	acceptLanguage := c.Request.Header.Get("Accept-Language")
	c.Writer.Header().Set("Content-Type", "application/json")
	...
	if vaiId, err := strconv.Atoi(c.Param("vai-id")); err != nil {
		...
		userId, _ := c.Get("userId")
		err := vai.DeleteVaiWithFlag(vaiId, userId.(int32))
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_WRITE_DATABASE, nil, lang, acceptLanguage, err))
		} else {
			c.String(http.StatusOK, "%s", response.ResponseSuccessJson(nil))
