...
func CreateDepartment(c *gin.Context) {
	...
	if err := serialization.UnmarshalFromJson(string(buf), l); err != nil {
		...
		r, err := department.CreateDepartment(l, userId.(int32))
		if err != nil {
...
func RetrieveDepartment(c *gin.Context) {
	lang := c.Request.FormValue("lang")
	acceptLanguage := c.Request.Header.Get("Accept-Language")
	c.Writer.Header().Set("Content-Type", "application/json")

	if departmentId, err := strconv.Atoi(c.Param("department-id")); err != nil {
		...
		r, err := department.RetrieveDepartment(int32(departmentId))
		if err != nil {
...
func UpdateDepartment(c *gin.Context) {
	...
	if err := serialization.UnmarshalFromJson(string(buf), l); err != nil {
		...
		userId, _ := c.Get("userId")
		err := department.UpdateDepartment(l, userId.(int32))
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_WRITE_DATABASE, nil, lang, acceptLanguage, err))
		} else {
...
func DeleteDepartment(c *gin.Context) {
	...
	if departmentId, err := strconv.Atoi(c.Param("department-id")); err != nil {
		...
		userId, _ := c.Get("userId")
		err := department.DeleteDepartment(departmentId, userId.(int32))
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_WRITE_DATABASE, nil, lang, acceptLanguage, err))
		} else {
			c.String(http.StatusOK, "%s", response.ResponseSuccessJson(nil))
...
func DeleteDepartmentWithFlag(c *gin.Context) {
	lang := c.Request.FormValue("lang")
	acceptLanguage := c.Request.Header.Get("Accept-Language")
	c.Writer.Header().Set("Content-Type", "application/json")
	...
	if departmentId, err := strconv.Atoi(c.Param("department-id")); err != nil {
		...
		userId, _ := c.Get("userId")
		err := department.DeleteDepartmentWithFlag(departmentId, userId.(int32))
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_WRITE_DATABASE, nil, lang, acceptLanguage, err))
		} else {
			c.String(http.StatusOK, "%s", response.ResponseSuccessJson(nil))
...
func QueryDepartment(c *gin.Context) {
	...
	if err := serialization.UnmarshalFromJson(string(buf), q); err != nil {
		...
		r, err := department.QueryDepartment(q)
		if err != nil {
			c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_READ_DATABASE, nil, lang, acceptLanguage, err))
		} else {
			c.String(http.StatusOK, "%s", response.ResponseSuccessJson(r))
...
func GetAllDepartments(c *gin.Context) {
	...
	r, err := department.GetAllDepartments()
	if err != nil {
		c.String(http.StatusInternalServerError, "%s", response.ResponseErrorJsonByErrorCode(myerror.ERROR_READ_DATABASE, nil, lang, acceptLanguage, err))
	} else {
		c.String(http.StatusOK, "%s", response.ResponseSuccessJson(r))
